...
import { exit, setcheckVersionList, setNowCheckVersion, setCheckId, setGroupBy, setDimension,setFunc, setNextShowConfiguration, setExtraColumns } from "@/reducers/indicator";
