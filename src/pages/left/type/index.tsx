...
import { AttrConfig, getDefaultTypeConfig, setTypes, setVersionModal, TypeConfig, TYPE_ID_PREFIX, TypePrototypeConfig, resetCurrentType, setCurrentVersion } from '@/reducers/type';
